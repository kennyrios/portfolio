...
(lib.Untitled2 = function(mode,startPosition,loop) {
	...
	this.shape_5.setTransform(275.5,144.3,7.705,7.705);
...
p.nominalBounds = new cjs.Rectangle(443.8,222.2,213.5,359.3);
// library properties:
lib.properties = {
	width: 550,
	height: 400,
